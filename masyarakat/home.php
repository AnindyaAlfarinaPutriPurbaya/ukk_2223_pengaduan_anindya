                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="editModal<?php echo $data['id_pengaduan'] ?>" tabindeex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form action="edit_data.php" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="id_pengaduan" value="<?= $data['id_pengaduan'] ?>" required readonly>
                                                            </div>
                                                                
                                                            <div class="mb-3">
                                                                <label class="form-label">Judul Laporan</label>
                                                                <input type="text" class="form-control" name="judul_laporan"
                                                                    placeholder="Masukkan Judul" value="<?= $data['judul_laporan'] ?>" autofocus required>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label class="form-label">Isi Laporan</label>
                                                                <textarea class="form-control" name="isi_laporan" placeholder="Masukan Isi Laporan"><?= $data['isi_laporan'] ?></textarea>
                                                            </div>
