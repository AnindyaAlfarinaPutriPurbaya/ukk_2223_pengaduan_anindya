<div class="container" style="padding-top: 10px; padding-bottom: 20%">
    <div class="row">
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: ">LAPORAN</th>
                                <th style="width: ">FOTO</th>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <?php
                                                        if (isset($_POST['kirim'])) {
                                                            ...
                                                            $updatequery = mysqli_query ($koneksi, "INSERT INTO tanggapan VALUES ('', '$id_pengaduan','$tanggal','$tanggapan','$id_petugas') ");
                                                            if ($tanggapan != NULL) {
