...
<head>
  ...
  <!-- =======================================================
  * Template Name: Hallo Public - v4.10.0
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Hallo Public</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#contact">Daftar Akun</a></li>
    ...
    <section id="Selamat Datang" class="Selamat Datang">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Tentang </h2>
          <p>Aplikasi Pengaduan Masyarakat merupakan aplikasi yan dapat dipergunakan oleh masyarakat untuk menyampaikan pengaduan atau keluhan mengenai pelayanan publik tertentu.</p>
        </div>
